...
class AppDelegate: UIResponder, UIApplicationDelegate, NSURLConnectionDelegate {
    ...
    var homeViewController: PictureListViewController!
    var welcomeViewController: WellcomeViewController!
...
//        self.activityViewController = nil;
    ...
    func monitorReachability() {
        ...
        reachability.whenReachable = { (reach: Reachability) in
            ...
            if self.isParseReachable() && PFUser.currentUser() != nil  { // 暫時不處理 && self.homeViewController!.objects!.count == 0
...
//                }
    ...
    func shouldNavigateToPhoto(targetPhoto: PFObject) {
