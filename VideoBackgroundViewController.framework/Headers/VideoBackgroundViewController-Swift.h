...
SWIFT_CLASS("_TtC29VideoBackgroundViewController29VideoBackgroundViewController")
@interface VideoBackgroundViewController : UIViewController

/// The video player to use for the video in the background
@property (nonatomic, readonly, strong) AVPlayerViewController * _Nonnull videoPlayer;
...
@property (nonatomic) BOOL videoShouldLoop;
...
///
/// \param animated It it appears animated or not
